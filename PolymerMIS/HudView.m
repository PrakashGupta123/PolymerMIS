...
- (id)loadingViewInView:(UIView *)aSuperview text:(NSString*)hudText
{
	...
	loadingView = [[HudView alloc] initWithFrame:CGRectMake((aSuperview.frame.size.width-180)/2,(aSuperview.frame.size.height-120)/2,180,120)];//75, 250, 180,120 //72,170,180,120//aSuperview.frame.size.height/2-60
	if (!loadingView)
	{
		return nil;
	}
	...
	if ([hudText length]>20) {
		...
		loadingLabel =[[UILabel alloc]initWithFrame:CGRectMake(0,0,160,160)];
   ...
   // [self setFrame:CGRectMake(70,180,180,120)];
	return loadingView;
}
