...
@implementation NewsLetterDetail

@synthesize headerLabel, backButton, homeButton, webView, newsletterName, newsletterURL, buttonMenu,newsDate;
...
- (void)viewDidLoad
{
   ...
   // [headerLabel setTextColor:[UIColor colorWithRed:23.0/255.0 green:87.0/255.0 blue:123.0/255.0 alpha:1]];
    [headerLabel setText:newsletterName];
...
//    NSString *url=[newsletterURL stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
//    //nslog(@"url=%@",url);
//    NSString *urlRequest=[NSString stringWithFormat:@"https://docs.google.com/viewer?url=%@",url];
...
//    
//    if ([[[NSUserDefaults standardUserDefaults] valueForKey:@"News"] isEqualToString:@"1"]) {
//        
//         NSString *url=[newsletterURL stringByReplacingOccurrencesOfString:@" " withString:@"%20"];
//        
//        
...
//        // NSString *urlRequest=[NSString stringWithFormat:@"https://docs.google.com/viewer?url=%@",url];
//       
//   // http://polymermis.com/inter_nationalprices.php?news_date=2015-11-24
//
//        
//        NSString *urlRequest1 = [NSString stringWithFormat:@"%@?news_date=%@",url,newsDate];
//                              
//                              
//                              
//                              
//        [self performSelector:@selector(showHUD:) withObject:@"Please wait..."];
//        NSURLRequest *request=[NSURLRequest requestWithURL:[NSURL URLWithString:urlRequest1]];
...
//            [webView setFrame:CGRectMake(5, 50, 310, 403)];
...
//            [webView setFrame:CGRectMake(15, 30, 430, 280)];
...
//            [backButton setFrame:CGRectMake(5, 0, 73, 32)];
//            [homeButton setFrame:CGRectMake(400, 0, 73, 32)];
//            [webView setFrame:CGRectMake(15, 30, 430, 260)];
            if(appDelegate.isMenuViewPresented)
            {
