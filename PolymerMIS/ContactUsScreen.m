...
@synthesize headerLabel, backButton, webView, buttonMenu;
...
- (void)viewDidLoad
{
    ...
    if ([[[NSUserDefaults standardUserDefaults]valueForKey:@"normalcontact"]isEqualToString:@"yes"])
    {
        _MenuBtn.hidden=YES;
    }
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        htmlString=[NSString stringWithFormat:@"<html><body style=\"-webkit-text-size-adjust: none;\"><font color=#FFFFFF><div align=\"center\"><img src=\"file://%@\" width=\"240\" height=\"49\" align=\"middle\"></div><br>Corporate Office:-<br>405, DURGA, A-8 Veera Indl. Estate,<br>Behind Balaji Telefilms,<br>Andheri (W), Mumbai (Mah.) 400053, India<br>Tel.:<font color=#17577B>+91-22-26736570,</font><br>Fax:+91-22-26736522<br>Email: contact@polymermis.com<br><br>Branch Office :-<br>218-A, Bansi Trade Center,<br>581/5 M.G. Road,<br>Indore, M.P. 452001, India<br>Tel.:<font color=#17577B>+91-731-4068185,</font><br>Fax: +91-731-4068185<br>Email: sales@polymermis.com<br>Mobile:+917389311669</font></font></body></html>",imagePath];
    ...
    else if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
    {
        ...
        htmlString=[NSString stringWithFormat:@"<html><body><font color=#FFFFFF size=\"5\"><div align=\"center\"><img src=\"file://%@\" width=\"281\" height=\"70\" align=\"middle\"></div><br>Corporate Office:-<br>405, DURGA, A-8 Veera Indl. Estate,<br>Behind Balaji Telefilms,<br>Andheri (W), Mumbai (Mah.) 400053, India<br>Tel.:<font color=#17577B>+91-22-26736570,</font><br>Fax:+91-22-26736522<br>Email: contact@polymermis.com<br><br>Branch Office :-<br>218-A,Bansi Trade Center,<br>581/5 M.G. Road,<br>Indore, M.P. 452001, India<br>Tel.:<font color=#17577B>+91-731-4068185,</font><br>Fax: +91-731-4068185<br>Email: sales@polymermis.com<br>Mobile:+917389311669</font></font></body></html>",imagePath];
    }
    
    [webView setBackgroundColor:[UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:0.1]];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:nil forKey:@"normalcontact"];
}
...
//            [webView setFrame:CGRectMake(5, 50, 310, 405)];
            webView.scrollView.scrollEnabled=NO;
...
//            [webView setFrame:CGRectMake(10, 30, 460, 260)];
